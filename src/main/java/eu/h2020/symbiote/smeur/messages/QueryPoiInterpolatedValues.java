...
public class QueryPoiInterpolatedValues {
	...
	public Map<String, WGS84Location> thePoints;	// The strings are used as IDs for the points and will re-occur in the response.
	...
	public QueryPoiInterpolatedValues(Map<String, WGS84Location> thePoints) {
												super();
	...
	public Map<String, WGS84Location> getThePoints() {
		return thePoints;
	}


	public void setThePoints(Map<String, WGS84Location> thePoints) {
		this.thePoints = thePoints;
	}
