...
public class QueryPoiInterpolatedValues {
	...
	String regionID;	// Must refer to a previously registered region.
	
	Map<String, Point> thePoints;	// The strings are used as IDs for the points and will re-occur in the response.
